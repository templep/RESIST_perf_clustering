...
def cluster_to_display(data, n_clust=None, link='ward', aff='euclidean', connect=None, cmpt_dist=False,threshold_dist=0):
	...
	model = AgglomerativeClustering(linkage=link, affinity=aff, connectivity=connect, n_clusters=None, compute_distances=cmpt_dist, distance_threshold=threshold_dist)
